...
def link_external_packages():
    ...
    lib_file_path = os.path.join(pykrita_resource_dir, DYNAPIX + "/lib")
    ...
    if dep_path not in sys.path:
        ...
        sys.path.append(os.path.join(pykrita_resource_dir, DYNAPIX))
...
XTC_PATH = os.path.join(WORKING_DIR, DYNAPIX + "/core/xt_consistency/")
# images
...
OUTPUT_NORMAL_PATH  = os.path.join(WORKING_DIR, DYNAPIX + "/OUTPUT_NORMAL.png")
# engine runner files
ENGINE_PYTHON_PATH = os.path.join(WORKING_DIR, "deps/bin/python3.9")
PIXELIZER_ENTRY_POINT = os.path.join(WORKING_DIR, DYNAPIX + "/core/pixelizer.py")
NORMALGEN_ENTRY_POINT = os.path.join(WORKING_DIR, DYNAPIX + "/core/normal_gen.py")
CONFIG_PATH = os.path.join(WORKING_DIR, DYNAPIX + "/engine.cfg")

IM_MODE = "RGBA"
# =================================== Extension ==================================

class DynaPix(DockWidget):
    def __init__(self):
        super().__init__()
        self.setup_gui()
...
Krita.instance().addDockWidgetFactory(DockWidgetFactory(
    "DynaPix", DockWidgetFactoryBase.DockRight, DynaPix))
